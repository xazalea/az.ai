...
export const PROVIDER_GROUPS: ProviderGroup[] = [
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'meta-llama/llama-2-70b-chat-hf', name: 'Llama 2 70B', description: 'Llama 2 70B Chat', type: 'chat', provider: 'Meta', route: '/api/deepinfra/v1/chat/completions' },
      { id: 'mistralai/mixtral-8x7b-instruct-v0.1', name: 'Mixtral 8x7B', description: 'Mixtral 8x7B Instruct', type: 'chat', provider: 'Mistral AI', speed: 'fast', route: '/api/deepinfra/v1/chat/completions' },
      { id: 'qwen/qwen2.5-72b-instruct', name: 'Qwen 2.5 72B', description: 'Qwen 2.5 72B Instruct', type: 'chat', provider: 'Qwen', route: '/api/deepinfra/v1/chat/completions' },
      { id: 'deepseek-ai/deepseek-v2.5', name: 'DeepSeek V2.5', description: 'DeepSeek V2.5 model', type: 'chat', provider: 'DeepSeek', speed: 'fast', route: '/api/deepinfra/v1/chat/completions' },
      { id: 'google/gemma-7b-it', name: 'Gemma 7B', description: 'Google Gemma 7B IT', type: 'chat', provider: 'Google', route: '/api/deepinfra/v1/chat/completions' },
      { id: '01-ai/yi-34b-chat', name: 'Yi 34B', description: '01.AI Yi 34B Chat', type: 'chat', provider: '01.AI', route: '/api/deepinfra/v1/chat/completions' },
      { id: 'microsoft/phi-3-medium-4k-instruct', name: 'Phi-3 Medium', description: 'Microsoft Phi-3 Medium', type: 'chat', provider: 'Microsoft', route: '/api/deepinfra/v1/chat/completions' },
      { id: 'stabilityai/stable-diffusion-xl-base-1.0', name: 'Stable Diffusion XL', description: 'Stable Diffusion XL for images', type: 'image', provider: 'Stability AI', route: '/api/deepinfra/v1/images/generations' },
    ],
  },
  {
    id: 'xai',
