...
export const PROVIDER_GROUPS: ProviderGroup[] = [
  ...
  },
  {
    ...
    models: [
      { id: 'dreamina', name: 'Dreamina AI', description: 'High-quality text-to-image & image-to-image (2K/4K)', type: 'image', provider: 'image' },
      { id: 'dreamina-4.0', name: 'Dreamina 4.0', description: 'Latest Dreamina model with enhanced quality', type: 'image', provider: 'image' },
      { id: 'dreamina-3.0', name: 'Dreamina 3.0', description: 'Previous generation model', type: 'image', provider: 'image' },
      { id: 'jimeng-api', name: 'Jimeng API (Enhanced)', description: 'Advanced image generation with composition', type: 'image', provider: 'image' },
      { id: 'imageai-google', name: 'ImageAI (Google)', description: 'Enhanced prompts via ImageAI', type: 'image', provider: 'image' },
      { id: 'imageai-openai', name: 'ImageAI (OpenAI)', description: 'DALL-E wrapper via ImageAI', type: 'image', provider: 'image' },
      { id: 'imagefx', name: 'ImageFX', description: 'Google ImageFX for photorealistic images', type: 'image', provider: 'image' },
      { id: 'pollinations-image-flux', name: 'Pollinations (Flux)', description: 'High quality Flux generation', type: 'image', provider: 'image' },
      { id: 'pollinations-image-turbo', name: 'Pollinations (Turbo)', description: 'Fast Flux generation', type: 'image', provider: 'image', speed: 'fast' },
    ],
  },
  {
    id: 'video',
