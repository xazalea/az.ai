...
export const registerApp = () => {
  ...
  // For Vercel, don't start server, just export the callback
...
export const getVercelApp = () => {
  if (!vercelApp) {
    registerApp();
  }
  return vercelApp?.callback();
};

export default getVercelApp();
